	  ...
	  <div class="head-t">
		...
		<ul class="megamenu skyblue">
			...
			<li style="float:right;"><a class="color1" href="feedbackshow.php">Feedbacks</a></li>
				<li class="active grid"><a class="color6" href="shoes.php">SHOES</a></li>			
			...
			<div class="products-grids">
				<div class="col-md-8 products-grid-left">
					...
					if(isset($_GET['filter_price']))
					{
						...
						if($price == 1)
						$sql = " SELECT * FROM products WHERE p_price < 500 AND p_type LIKE 'Shoes'";
						if($price == 2)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 500 AND 1000 AND p_type LIKE 'Shoes'";
						if($price == 3)
						$sql = " SELECT * FROM products WHERE p_price BETWEEN 1000 AND 2000 AND p_type LIKE 'Shoes'";
						if($price == 4)
						$sql = " SELECT * FROM products WHERE p_price > 2000 AND p_type LIKE 'Shoes'";				
						if (!$conn) {
