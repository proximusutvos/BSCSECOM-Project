...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			<div class="top_right">
				<ul>
					<li><a href="signup1.php">Register an Account</a></li>
					<li><a href="#">Welcome -- Guest</a></li>					
					<li><a href="login1.php">Login Please</a></li>	
					
				</ul>
			</div>
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="#">Feedback .</style></a> | Call us : +63 902921341</span>
			</div>
...
<div class="header_bg">
   <div class="container">
	<div class="header">
	  <div class="head-t">
		  <div class="logo">
			  <a href="#.php"><h1>BSCS-3 <img src="images/logo.png" width="80px" height="80px" style="border-radius: 100%" /><span> Shop</span></h1> </a>
		...
		<ul class="megamenu skyblue">
			...
			<li style="float:right;"><a class="color1" href="#">Cart</a></li>
			<li style="float:right;"><a class="color1" href="#">About</a></li>
			<li style="float:right;"><a class="color1" href="#">Feedbacks</a></li>
...
<form action="checklogin1.php" method="post">
  <center><h3>Dont have an account yet? <a style="color:blue;font-size: 14px" href="signup1.php">REGISTER HERE</a>.</h3></center><br>
  <fieldset style="border:1px solid gray;border-padding:1px"><center><legend><h2><br>Login Existing User.<br></h2></legend></center>
  <br>
  <fieldset style="padding: 20px 20px">
    <label for="name"><h3>Username:</h3></label>
    <input type="text" id="name" name="user_name" >

    <label for="passw"><h3>Password:</h3></label>
