						...
						<div class="flexslider">
							  <ul class="slides">							  
								...
								<div class="col-md-7 single-text">
									...
									<h4>Postal Code:-</h4> <input type="text" size="4" name="pincode" pattern="\d{4}" title="4 digit postal code" required>
									<h4>Region:-</h4> <input type="text" size="15" name="city"  title="Only integers allowed" required>
									<h4>City:-</h4> <input type="text" size="30" name="state" pattern="[a-zA-Z]+" title="Only alphabets allowed" required>
									<h4>Mobile No.:-</h4> <input type="tel" name="mobile" pattern="[\+]\d{11}" require title="Format: +63XXXXXXXXX" value="+63" required>
									<br><br>
									<h2>Payment Method:</h2> <br>
									<input type="radio" checked> Cash on Delivery (COD)<br>
									<input type="radio" disabled> Paypal / Visa / Mastercard / Gcash
									<br><br>';
					...
					<div class="w_sidebar">
						<div class="w_nav1">
							...
							<ul>
								...
								while($row = mysqli_fetch_assoc($result)) {
								echo '								
								<h1>'.$row['p_name'].'</h1><br><h2><a href="#">Price:</a></h2><h2><span>₱ '.$row['p_price'].'</span></h1>';
								}
								}
								?></li>
								<li></li>
