	...
	<div class="header">
	  <div class="head-t">
		...
		<ul class="megamenu skyblue">
			...
			<li class="active grid"  style="float:right;"><a class="color1" href="cart.php">Cart</a></li>
...
<?php
	...
	if (isset($_POST['fullname']) && isset($_POST['product_id']) && isset($_POST['address']) && isset($_POST['pincode']) && isset($_POST['city']) && isset($_POST['state']) && isset($_POST['mobile']))
	{
		$name = $_POST['fullname'];
		...
		$sql = "Insert into orders (p_id,fullname,address,pincode,region,city,mobile) values  ('$pid','$name','$add','$pin','$citi','$stat','$mob')";
				$result = mysqli_query($conn,$sql) or mysqli_error($conn);
				
				/*for deleting the item ordered from the cart*/
		$sql = "Delete from cart where c_p_id = $pid AND c_u_id = $id";
				$result = mysqli_query($conn, $sql);
				echo '<span style="color:#00ccff;text-align:center;"><center><h1> Your ORDER has been placed successfully</h1></center></span>'; 
				echo '<br><h1><center>Go Back To -> <a href="shoes.php">Shoes</a> / <a href="tshirt.php">T-SHIRT</a> / <a href="watches.php">WATCHES</a>  /  <a href="cart.php">Go To Cart</a></center></h1>';
	}
?>
<!--//storing complete-->
</div>
