				...
				<div class="col-md-8 products-grid-left">
					...
					<?php					
						...
						if(isset($_GET['filter_price']))
						{
							...
							if($price == 0)
							$sql = " SELECT * FROM products WHERE p_type LIKE 'Tshirt'";					
							if($price == 1)
							$sql = " SELECT * FROM products WHERE p_price < 500 AND p_type LIKE 'Tshirt'";
							if($price == 2)
							$sql = " SELECT * FROM products WHERE p_price BETWEEN 500 AND 1000 AND p_type LIKE 'Tshirt'";
							if($price == 3)
							$sql = " SELECT * FROM products WHERE p_price BETWEEN 1000 AND 2000 AND p_type LIKE 'Tshirt'";
							if($price == 4)
							$sql = " SELECT * FROM products WHERE p_price > 2000 AND p_type LIKE 'Tshirt'";
