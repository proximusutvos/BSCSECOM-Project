...
<!--products-->
	...
	if (isset($_POST['user_name']) && isset($_POST['user_password']))
	{
		...
		{
				echo '<center><strong> SORRY!!!! Username OR Email OR Mobile Number already exist</strong></center><br>'; 
				echo '<center><h1><a href="signup1.php">Click here to Register again</a></h1></center>'; 
				?>
				<script type="text/javascript">
					alert("This Website Requires you to have an account to shop. you may login if you already have an existing account if not, you may register. UNAUTHORIZED USER CANNOT SHOP IN THIS WEBSITE.");
				</script>
				<?php
				}
				else
				{
						...
						echo '<center><strong>User Registered Succesfully!</strong></center><br>'; 
