								...
								if (mysqli_num_rows($result) > 0) 
								{
									...
									<div class="details-left-info simpleCart_shelfItem">
										...
										<div class="price_single">
											<span class="actual item_price">'.$row['p_name'].'--    ₱ '.$row['p_price'].'</span>
										</div>
										<h2 class="quick">Quick Overview</h2>
										<p class="quick_desc"> lodi lodi potiti ex-b! ocdawgs hypebeast forevahhhh yayayaya listen up savage x lil pussy ayayaya
										sdasd kami ang mga hypebeast ng trinoma pinakamalupet sa lahat yeah boy.</p>
										<h3>Length</h3>
										<ul class="size">
											<li><a href="#">7</a></li>
											<li><a href="#">6</a></li>
	...
	<div class="col-md-4 products-grid-right">
					<div class="w_sidebar">
						...
						<section  class="sky-form">
							<h4>SHOP MORE THIS SUMMER!</h4>
							<div class="row1 scroll-pane">
														<h5>GET TO ATLEAST 60% DISCOUNT THIS SUMMER</h5>	<br>
								<div class="col col-4">
										<img src="images/promo1.jpg" width="89%" alt=""/>
								</div>
								<div class="col col-4">									
								</div>
							</div>
						...
						<br>
						<section  class="sky-form">
							<h4>GET MORE HYPEBEAST!</h4>
							<div class="row1 scroll-pane">
								<center><h5>BE MORE MALUPET WITH LODI</h5></center><br>
								<div class="col col-4">	
								<img src="images/model.jpg" width="93%" alt=""/>						
								</div>
							</div>
						</section>
					</div>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        Pang malupitan na suotan ng mga hypebeast galawang hypebeast ayayaya ex-b malupert lodi ejejejeje yeah boy Pang malupitan na suotan ng mga hypebeast galawang hypebeast ayayaya ex-b malupert lodi ejejejeje yeah boy Pang malupitan na suotan ng mga hypebeast galawang hypebeast ayayaya ex-b malupert lodi ejejejeje yeah boy Pang malupitan na suotan ng mga hypebeast galawang hypebeast ayayaya ex-b malupert lodi ejejejeje yeah boy Pang malupitan na suotan ng mga hypebeast galawang hypebeast ayayaya ex-b malupert lodi ejejejeje yeah boy Pang malupitan na suotan ng mga hypebeast galawang hypebeast ayayaya ex-b malupert lodi ejejejeje yeah boy
      </div>
    </div>
  </div>
  <div class="panel panel-default">
