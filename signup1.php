...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			...
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="#.php">Feedback .</style></a> | Call us : +63 902921341</span>
			</div>
...
<div class="header_bg">
   <div class="container">
	<div class="header">
	  <div class="head-t">
		 <div class="logo">
			  <a href="#"><h1>BSCS-3 <img src="images/logo.png" width="80px" height="80px" style="border-radius: 100%" /><span> Shop</span></h1> </a>
...
<form action="acct_created1.php" method="post">
  ...
  <fieldset>
    ...
    <input type="tel" pattern="[\+]\d{11}" id="mobile" name="user_mobile" require title="Format: +63XXXXXXXXX" value="+63">    
